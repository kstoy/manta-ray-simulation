"""Run the blocking controller experiment 10 times and save per-timestep distance metrics."""
import sys
import time
import pickle
import contextlib
...
N_RUNS = 100
CONTROLLER_NAME = "blocking"
OUTPUT_PATH = Path(__file__).parent / "data_blocking.pkl"
